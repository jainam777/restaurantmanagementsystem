...
lblInfo=Label(Tops,font=('arial',50,'bold'),text=" Cafe ",fg="Steel Blue",bd=10,anchor='w')
...
btnPrint=Button(f1,padx=16,pady=8,bd=16,fg="black",font=('arial',16,'bold'),width=10,text="Print",bg="powder blue",command=print()).grid(row=7,column=4)
